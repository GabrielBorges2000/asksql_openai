  ...
  return (
    <div className="max-w-[780px] mx-auto px-4 pt-12 pb-4">
      <Head>
        ...
        <meta
          property="og:url"
          content="https://asksql-gabrielborges2000.vercel.app/"
        />
        <meta
          property="og:image"
      ...
      >
        ...
        <div className=' h-40 overflow-auto my-4 bg-blueberry-600 border border-blueberry-300 rounded-md px-4 py-3 focus-within:ring-2 focus-within:ring-lime-600 "'>
          <Editor
